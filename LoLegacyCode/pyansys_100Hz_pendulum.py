...
exec_file = ansys_path[0] # "C:\Program Files\ANSYS Inc\v231\ansys\bin\winx64\MAPDL231.exe" # 
print(ansys_path[0])
mapdl = launch_mapdl(exec_file, additional_switches='-smp',loglevel="ERROR")
